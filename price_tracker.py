...
def find_deals(offers: list[dict]) -> list[dict]:
    """Detecta ofertas bajo el umbral fijo. El umbral es un techo duro:
    ningún precio sobre él se notifica. La comparación histórica es info adicional."""
    ...
    for offer in offers:
        ...
        if not threshold or offer["price"] > threshold:
            continue
